...
2. **Error:** Injected workflow path and `elixir/WORKFLOW.md` both missing or unreadable. Expect harness to stop after reporting the blocker; no partial writes to skills.
