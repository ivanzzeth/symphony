...
3. **Continuation:** Resume harness configuration from current tree. Expect
   re-audit, no duplicate agent files, **`linear`** / **`land`** / **`pull`** alignment verified (including **`symphony-linear`** / **`symphony-land`** / **`symphony-pull`** mirror skills when those trees are used).
