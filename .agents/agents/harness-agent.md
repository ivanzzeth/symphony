...
- **Missing WORKFLOW.md**: If the injected path is absent or unreadable, read **`elixir/WORKFLOW.md`** in this monorepo as the canonical execution contract. If that file is also missing, report and exit — the harness cannot align without the contract.
