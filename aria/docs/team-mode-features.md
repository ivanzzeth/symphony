...
This document describes the enhanced team mode features added to Aria, inspired by oh-my-codex (OMX) and oh-my-claude-sisyphus (OMC) implementations.
