# AGENTS.md — Aria Project Guidelines

## Project Overview

**Project**: Aria — Go reimplementation of OpenAI's Symphony using Charm TUI stack

**Module**: `github.com/junhoyeo/aria`

**Go Version**: 1.25.0

**Repository**: https://github.com/junhoyeo/aria

## Architecture

```
aria/
├── cmd/aria/          # CLI entry point
├── internal/
